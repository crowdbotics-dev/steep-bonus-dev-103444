"""
Django settings for steep_bonus_dev_103444 project.
...
ROOT_URLCONF = 'steep_bonus_dev_103444.urls'
...
WSGI_APPLICATION = 'steep_bonus_dev_103444.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "steep_bonus_dev_103444 API",
    "DESCRIPTION": "API documentation for steep_bonus_dev_103444 App",
    "VERSION": "v1",
}
